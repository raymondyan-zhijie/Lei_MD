...
> 🌐 **Language**: **中文** | [English](04-testing-plan.en.md)
...
> 错误码体系（5 大类、错误信息规范、国际化、崩溃恢复）的**权威定义**见 [docs/02-architecture.md §6](02-architecture.md)。本节仅列出与测试场景的映射。

| 场景 | 期望行为 | 错误码（详见 02 §6.1） |
|------|----------|------------|
...
| 拖入音频 (mp3/wav) | v1.0 明确提示「v1.1+ 支持」（[01 F9a](01-requirements.md)） | `E_FILE_006` |
